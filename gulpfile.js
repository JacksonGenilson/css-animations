...
const sass      = require('gulp-sass')(require('node-sass'));        // Pacote do compilador do sass para o Gulp
...
gulp.task('scss', () => {
    return gulp.src(paths.styles)   // Arquivo(s) que o gulp irá procurar na tarefa
